...
@Component
class HumanMethylationDataImport @Autowired constructor(
    ...
    private fun methylationDataFromColumnName(name: String, firstRow: CsvRow, targetRow: CsvRow): Double?  {
    ...
    private fun typeExtraction(firstRow: CsvRow): MutableList<String> {
    ...
    private fun valueMapOf(first: CsvRow, target: CsvRow) : Map<String, Double> =
